    ...
    public partial class ucOlvideContraseña : UserControl
    {
        ...
        private void mbtEnviarNuevaContreseña_Click(object sender, EventArgs e)
        {
            ...
            if (StEmail != null && StEmail != "Usuario Bloqueado")
            {
                ...
                int id_usuario = varModelo.SelectIdUsuarioxNombreUsuario(this.mTxtOlvide.Text);
                this.bindingSourceActualizaContraseña.DataSource = this.varModelo.UPD_ACTUALIZAR_CONTRASENA(id_usuario, nuevacadena);
            }
            else
            {
                if (StEmail != null)
